            ...
            >
              ...
              >
                ...
                <v-btn
                  ...
                  elevation="2"
                >
                  <v-icon v-if="grantFavorite" color="pink">mdi-heart</v-icon>
                  <v-icon v-show="!grantFavorite" color="#00a368"
                ...
                <v-btn
                  ...
                  class="ml-4"
                >
                  <v-icon v-if="grantFlag" color="#00a368"
                    >mdi-thumb-down</v-icon
                  >
                  <v-icon v-show="!grantFlag" color="#00a368"
