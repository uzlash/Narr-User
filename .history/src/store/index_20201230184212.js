...
const store = new Vuex.Store({
  ...
  actions: {
    ...
    'socket_event:user:login'({ commit },   user) {
      console.log('Logged in using socket!', JSON.stringify(user))
    ...
    'socket_event:user:logout'({ commit }, JSON.stringify user) {
      console.log('User Logged Out using socket!', JSON.stringify(user) )
      this._vm.$toast.warning(`User Logged Out:  ${user.fullName}`)
