        ...
        <v-row>
          ...
          >
            ...
            >
              ...
              <v-card-text class="body-1 pa-0 text-center font-weight-light text-icon">
                 <v-icon color="" left>mdi-email</v-icon>
                
                {{
                user.email
              }}</v-card-text>
              <v-card-text class="body-2 pa-0 text-center font-weight-light text-icon">
                <v-icon color="" left>mdi-school</v-icon>
              ...
              <div class="d-flex justify-center">
                <v-btn outlined small class="mt-2" color="#00a368" to="/profile">
